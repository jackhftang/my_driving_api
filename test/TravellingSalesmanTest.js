const {shortestRoute, shortestRouteSlow, dist} = require('../src/lib/algorithm/ShortestRoute');
const expect = require('expect');

describe('ShortestRoute', function(){

  it('should return distance and path', function(){
    let res = shortestRoute([
      [0, 1, 3],
      [1, 0, 1],
      [2, 3, 0]
    ], 1);
  ...
  it('should return same result as shortestRouteSlow', function(){
